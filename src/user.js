...
export default class User extends Component {
    render() {
        return ( <
            >
            <
            h2 className = "txt" > Hello Krishna
            ...
            href = "#"
            data_filter = "*" > All Works < /a></li >
            <
            li > < a href = "#"
            data_filter = ".creative" > Creative < /a></li >
            <
            li > < a href = "#"
            data_filter = ".corporate" > Corporate < /a></li >
            <
            li > < a href = "#"
            data_filter = ".portfolio" > Portfolio < /a></li >
            <
            /ul>
            //  /#portfolio-filter--
            <
            ...
            p className = "text-center wow fadeInDown" > SkyAge IT Services Pvt.Ltd.is India’ s fastest growing IT Company with / strongfocus on Big data solutions,
            Cloud Computing,
            Machine Learning,
            ...
            &
            copy; 2018 SkyAge IT Services Pvt.Ltd..Designed by Team < /b>< a target = "_blank"
            href = "http://skyage.in/"
